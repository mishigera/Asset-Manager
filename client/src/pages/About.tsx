        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
              Soy Gerardo, un ingeniero de software de Guadalajara apasionado por crear experiencias digitales excepcionales utilizando las últimas tecnologías web e inteligencia artificial.
            </p>
          ...
          >
            ...
            {/* A placeholder for a profile image - intentionally minimal for Vercel style */}
